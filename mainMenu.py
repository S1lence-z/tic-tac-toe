...
class MainMenu:
    def __init__(self, root):
        ...
        # Main menu frame
        self.title = tk.Label(title_frame, padx=10, pady=10, text="Main Menu", font=(h.font1, h.title_size), bg=h.title_colour)
        self.title.pack()
        ...
        # A button for PvP
        self.pvp_button = tk.Button(buttonframe, width = 14, height=7,  text="PvP", font=(h.font1, h.font1_size), bg=h.button_colour,command=self.action0)
        self.pvp_button.grid(row=0, column=0, pady=5)
        
        # A button for PvE
        self.pve_button = tk.Button(buttonframe, width = 14, height=7, text="PvE", font=(h.font1, h.font1_size), bg=h.button_colour, command=self.action1)
        self.pve_button.grid(row=0, column=1, pady=5, padx=5)

        # A button for 3x3
        self.grid3_button = tk.Button(buttonframe, width=14, height=7, text="3x3", font=(h.font1, h.font1_size), bg=h.button_colour, command=self.action2)
        self.grid3_button.grid(row=1, column=0, pady=5, padx=5)

        # A button for 4x4
        self.grid4_button = tk.Button(buttonframe, width=14, height=7, text="4x4", font=(h.font1, h.font1_size), bg=h.button_colour, command=self.action3)
        ...
        # Start button
        self.start_button = tk.Button(start_button_frame, width=14, height=7, text="START", font=(h.font1, h.font1_size), fg=h.text_button_colour,bg=h.button_colour, command=self.action4)
