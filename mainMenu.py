...
class MainMenu:
    def __init__(self, root: tk, h: Help()) -> None:
        ...
        # Start button
        self.start_button = tk.Button(start_button_frame, width=14, height=7, text="START", bg=h.start_button_colour, command=self.action4)
        self.start_button.configure(font=(h.start_button_text_colour, h.button_text_size))
